...
Route::get('/register', [WebHomeController::class, 'registrationForm'])->name('registration');
...
Route::group(['middleware' => 'auth', 'prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'checkAdmin'], function () {
        ...
        Route::get('/statisticians', [UserController::class, 'statisticians'])->name('admin.statisticians');
